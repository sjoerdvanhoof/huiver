...
/// The ambient load indicator: a band of gold water that rises as the models
/// load and stills to a flat line when they are ready. It replaces the old
/// full-screen prepare state — the library stays usable while it fills.
    ...
    private var caption: some View {
        VStack(alignment: .leading, spacing: 2) {
            ...
            if firstRun, phase == .filling {
                Text("First launch compiles the voice model for this iPhone — a few minutes, once. Keep the app open.")
            }
        }
        .font(.huiverCaption)
